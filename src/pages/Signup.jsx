...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(typeof err === 'string' ? err : 'Signup failed. Please check your information and try again.');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-white sm:bg-secondary-50/50 px-4 py-16 selection:bg-primary-100 selection:text-primary-900">
      <div className="w-full max-w-[640px] animate-fade-in transition-all">
        ...
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <h1 className="text-4xl font-extrabold text-secondary-900 tracking-tight">Create your account</h1>
          <p className="text-secondary-500 mt-3 font-medium text-lg">Join 2 million+ users sending money globally</p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-secondary-500 uppercase tracking-widest ml-1">ID Number</label>
                  <input
                    type="text"
                    name="idNumber"
                ...
                {/* Gender */}
                <div className="space-y-2">
                  <label className="text-xs font-bold text-secondary-500 uppercase tracking-widest ml-1">Gender</label>
                  <select
                    name="gender"
                ...
                {/* Date of Birth */}
                <div className="space-y-2">
                  <label className="text-xs font-bold text-secondary-500 uppercase tracking-widest ml-1">Date of Birth</label>
                  <input
                    type="date"
                    name="dateOfBirth"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Password */}
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-secondary-500 uppercase tracking-widest ml-1">Password</label>
                  ...
                  {/* Confirm Password */}
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-secondary-500 uppercase tracking-widest ml-1">Confirm Password</label>
                    <div className="relative">
                      <input
        ...
        <p className="mt-10 text-center text-secondary-500 font-medium">
          ...
          <Link to="/login" className="text-primary-600 hover:text-primary-700 font-bold hover:underline underline-offset-4 transition-all">
            Sign in here
          </Link>
        </p>
      </div>
