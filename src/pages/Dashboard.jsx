          ...
          {error && (
            <div className="bg-red-50 border border-red-100 text-red-600 p-6 rounded-3xl mb-8 flex items-start gap-4 animate-slide-up">
              ...
              <div className="flex-1">
                ...
                <button onClick={fetchDashboardData} className="mt-3 text-sm font-bold underline hover:translate-x-1 transition-transform inline-block">
                  Try again
                </button>
              </div>
            </div>
          ...
          {!loading && !error && dashboardData && (
            <div className="space-y-10 animate-fade-in">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Account Balance */}
                <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-secondary-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
                  ...
                  <div className="flex flex-col">
                    <span className="text-2xl md:text-3xl font-extrabold text-secondary-900 tracking-tight">
                      ${Number(dashboardData.transfiBalance).toLocaleString()}
                    </span>
                    <span className="text-emerald-500 text-xs md:text-sm font-bold mt-2 flex items-center gap-1">
                ...
                <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-secondary-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-secondary-400 text-xs md:text-sm font-medium mt-2">
                      Est. clearing 24-48h
                    </span>
                  </div>
                </div>
                ...
                {/* Total Balance */}
                <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-sm border border-secondary-100 hover:shadow-xl hover:-translate-y-1 transition-all group sm:col-span-2 lg:col-span-1">
                  <div className="flex items-center gap-4 mb-6">
                  ...
                  <div className="flex flex-col">
                    ...
                    <span className="text-primary-600 text-xs md:text-sm font-bold mt-2">
                      Master Account
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-[2.5rem] shadow-sm border border-secondary-100 overflow-hidden">
                <div className="p-6 md:p-8 border-b border-secondary-100 flex items-center justify-between">
                  <h2 className="text-lg md:text-xl font-bold text-secondary-900">
                    Recent Transactions
                  </h2>
                  <button className="text-primary-600 font-bold hover:text-primary-700 text-xs md:text-sm transition-colors">
                    View All
                  </button>
                </div>
                <div className="p-8">
                    ...
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex items-center justify-between group cursor-pointer">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 md:w-12 md:h-12 bg-secondary-50 rounded-2xl flex items-center justify-center text-secondary-500 group-hover:bg-primary-50 group-hover:text-primary-600 transition-colors">
                            <svg className="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" />
                            </svg>
                          </div>
                          <div>
                            <p className="font-bold text-secondary-900 text-sm md:text-base">Transfer to Alice Johnson</p>
                            <p className="text-secondary-400 text-xs md:text-sm font-medium">Oct 24, 2023 · 2:30 PM</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-extrabold text-secondary-900 text-sm md:text-base">-$450.00</p>
                          <p className="text-emerald-500 text-[10px] md:text-xs font-bold uppercase tracking-widest mt-0.5">Completed</p>
                        </div>
                      </div>
                    ))}
                  </div>
