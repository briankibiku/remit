        ...
        <div className="max-w-7xl mx-auto px-6 py-10 lg:px-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6 animate-fade-in">
            <div>
              ...
              <p className="text-secondary-500 font-medium mt-1">Here's what's happening with your accounts today.</p>
            </div>
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-20 animate-fade-in">
              ...
              <p className="mt-4 text-secondary-500 font-medium">Preparing your insights...</p>
            </div>
          )}
            ...
            <div className="space-y-10 animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-secondary-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-secondary-500 font-bold uppercase tracking-wider text-xs">Available Funds</span>
                  </div>
                ...
                <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-secondary-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-secondary-500 font-bold uppercase tracking-wider text-xs">Pending Clearing</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-3xl font-extrabold text-secondary-900 tracking-tight">
                ...
                <div className="bg-white p-8 rounded-[2rem] shadow-sm border border-secondary-100 hover:shadow-xl hover:-translate-y-1 transition-all group lg:col-span-1">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-secondary-500 font-bold uppercase tracking-wider text-xs">Total Assets</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="text-3xl font-extrabold text-secondary-900 tracking-tight">
              ...
              <div className="bg-white rounded-[2.5rem] shadow-sm border border-secondary-100 overflow-hidden">
                <div className="p-8 border-b border-secondary-100 flex items-center justify-between">
                  <h2 className="text-xl font-bold text-secondary-900">Recent Transactions</h2>
                  <button className="text-primary-600 font-bold hover:text-primary-700 text-sm transition-colors">View All</button>
                </div>
                <div className="p-8">
                    ...
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="flex items-center justify-between group cursor-pointer">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <p className="font-bold text-secondary-900">Transfer to Alice Johnson</p>
                            <p className="text-secondary-400 text-sm font-medium">Oct 24, 2023 · 2:30 PM</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-extrabold text-secondary-900">-$450.00</p>
                          <p className="text-emerald-500 text-xs font-bold uppercase tracking-widest mt-0.5">Completed</p>
                        </div>
                      </div>
                    ))}
                  </div>
