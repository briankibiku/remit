      ...
      <main className="flex-1 overflow-y-auto">
        <div className="max-w-5xl mx-auto px-6 py-10 lg:px-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6 animate-fade-in">
            <div>
              <h1 className="text-3xl font-extrabold text-secondary-900 tracking-tight flex items-center gap-3">
                API Credentials
                <span className="p-1 px-2.5 bg-primary-100 text-primary-600 rounded-lg text-xs font-black uppercase tracking-widest">
                  v1.2
                </span>
              </h1>
              <p className="text-secondary-500 font-medium mt-1">
                Manage your integration access and security credentials.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-secondary-400 text-sm font-medium">
                    Generating a new key will immediately revoke the current
                    one.
                  </p>
                </div>
              </div>
            ...
            <div
              className="bg-white rounded-[2.5rem] shadow-sm border border-secondary-100 overflow-hidden animate-slide-up"
              ...
              <div className="p-10 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="group cursor-default">
                    <label className="text-secondary-400 text-[10px] font-black uppercase tracking-widest block mb-2 px-1">
                      Client Identifier
                    </label>
                    <div className="p-4 bg-secondary-50 border border-secondary-100 rounded-2xl group-hover:border-primary-100 group-hover:bg-white transition-all">
                      <p className="font-mono text-secondary-900 font-bold tracking-tight">
                  ...
                  <div className="relative group">
                    ...
                    {apiKey && (
                      <div className="absolute top-4 right-4 animate-fade-in">
                        <span className="p-1 px-2.5 bg-emerald-500 text-white rounded-lg text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-500/20">
                          Active
                        </span>
                      </div>
                    )}
            ...
            {/* Documentation CTA */}
            <div
              className="bg-primary-600 rounded-[2.5rem] p-10 text-white flex flex-col md:flex-row items-center justify-between gap-8 animate-fade-in"
            ...
            >
              <div className="text-center md:text-left">
                ...
                <p className="text-primary-100 font-medium">
                  Explore our developer hub for SDKs and API references.
                </p>
              </div>
              <button
                onClick={() =>
                  window.open("https://rem.propel.co.ke/", "_blank")
                }
                className="px-8 py-4 bg-white text-primary-600 rounded-2xl font-black text-sm hover:shadow-2xl hover:scale-105 transition-all active:scale-95 whitespace-nowrap"
              >
                Go to Documentation
              </button>
            </div>
