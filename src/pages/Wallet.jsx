...
const Wallet = () => {
  ...
  const fetchWalletData = async () => {
    try {
      ...
      setTimeout(() => {
        setWalletData({
          totalBalance: 4500750.00,
          pendingTransactions: 120500.00,
          availableWithdrawal: 4380250.00,
          currency: 'USD'
        });
        setLoading(false);
      }, 700);
        ...
        <div className="max-w-7xl mx-auto px-6 py-10 lg:px-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-6 animate-fade-in">
            <div>
              ...
              <p className="text-secondary-500 font-medium mt-1">Manage your funds, transfers, and digital assets.</p>
            </div>
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-32 animate-fade-in">
              ...
              <p className="mt-6 text-secondary-500 font-bold tracking-tight uppercase text-xs">Accessing encrypted vault...</p>
            </div>
          )}
          ...
          {error && (
            <div className="bg-red-50 border border-red-100 text-red-600 p-8 rounded-[2.5rem] mb-12 flex items-start gap-5 animate-slide-up">
              ...
              <div>
                <h3 className="font-extrabold text-xl tracking-tight">Access Denied</h3>
            ...
            <div className="space-y-10 animate-fade-in">
              ...
              <div className="bg-secondary-900 rounded-[3rem] p-12 text-white relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-10">
                  <div>
                    <span className="text-secondary-400 font-black uppercase tracking-[0.2em] text-xs">Total Combined Portfolio</span>
                    <h2 className="text-6xl font-black mt-4 tracking-tighter flex items-center gap-4">
                      ...
                      {walletData.totalBalance.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                    </h2>
                    <div className="flex items-center gap-6 mt-10">
                      <div className="flex flex-col">
                        <span className="text-secondary-400 text-[10px] font-black uppercase tracking-widest">Available</span>
                        <span className="text-emerald-400 font-bold text-lg">${walletData.availableWithdrawal.toLocaleString()}</span>
                      </div>
                      <div className="w-px h-10 bg-secondary-700/50"></div>
                      <div className="flex flex-col">
                        <span className="text-secondary-400 text-[10px] font-black uppercase tracking-widest">In Transit</span>
                        <span className="text-amber-400 font-bold text-lg">${walletData.pendingTransactions.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-center md:items-end gap-6">
                    ...
                    <div className="text-right">
                      <p className="text-white font-black uppercase tracking-widest text-xs">Secure Vault</p>
                      <p className="text-secondary-400 text-[10px] font-medium mt-1">256-bit AES Encryption</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white p-10 rounded-[2.5rem] border border-secondary-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group">
                  ...
                  <h3 className="text-2xl font-black text-secondary-900 tracking-tight">Internal Transfer</h3>
                  <p className="text-secondary-500 font-medium mt-2 leading-relaxed">Move funds instantly between your accounts and sub-wallets without any network fees.</p>
                ...
                <div className="bg-white p-10 rounded-[2.5rem] border border-secondary-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all group">
                  ...
                  <h3 className="text-2xl font-black text-secondary-900 tracking-tight">Withdraw Funds</h3>
                  <p className="text-secondary-500 font-medium mt-2 leading-relaxed">Liquidate your available balance to your linked bank account or external crypto address.</p>
