      ...
      <div className="w-full max-w-md relative animate-fade-in">
        <div className="text-center mb-10">
          ...
          <p className="text-secondary-500 font-medium mt-2 leading-relaxed">
            ...
            <span className="text-secondary-900 font-bold">{email || 'your email'}</span>
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div>
              ...
              <p className="mt-4 text-center text-sm text-secondary-400 font-medium">
                Didn't receive the code? <button type="button" className="text-primary-600 font-bold hover:text-primary-700 underline-offset-4 hover:underline transition-all">Resend</button>
              </p>
            </div> 
