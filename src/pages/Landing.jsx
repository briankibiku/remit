        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="flex items-center gap-8">
              ...
              <Link
                to="/signup"
                className="bg-primary-600 text-white px-6 py-2.5 rounded-full font-semibold hover:bg-primary-700 transition-all shadow-sm hover:shadow-md hover:scale-105 active:scale-95"
              >
                Get Started
              </Link>
            </div>
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-10 animate-fade-in">
              <div className="inline-flex items-center gap-2 bg-primary-50 px-4 py-2 rounded-full border border-primary-100">
                ...
                <span className="text-primary-700 text-sm font-semibold tracking-wide uppercase">New: Instant Transfers to 190+ Countries</span>
              </div>
              ...
              <p className="text-xl text-secondary-600 leading-relaxed max-w-xl">
                Experience the fusion of speed and security. Move funds across borders with transparent rates and zero hidden fees.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                ...
                <Link to="/partner-login" className="inline-flex items-center justify-center gap-2 bg-white border border-secondary-200 text-secondary-900 px-10 py-4 rounded-full font-bold hover:bg-secondary-50 transition-all hover:scale-105 active:scale-95">
              ...
              <div className="flex items-center gap-12 pt-6 border-t border-secondary-100">
                <div className="space-y-1">
                  <div className="text-3xl font-bold text-secondary-900">195+</div>
                  <div className="text-sm font-medium text-secondary-500 uppercase tracking-wider">Countries</div>
                </div>
                <div className="space-y-1">
                  <div className="text-3xl font-bold text-secondary-900">2M+</div>
                  <div className="text-sm font-medium text-secondary-500 uppercase tracking-wider">Happy Users</div>
                </div>
                <div className="space-y-1">
                  <div className="text-3xl font-bold text-secondary-900">$5B+</div>
                  <div className="text-sm font-medium text-secondary-500 uppercase tracking-wider">Processed</div>
                </div>
              </div>
            </div>
              ...
              <div className="relative z-10 bg-white rounded-3xl p-8 shadow-2xl border border-secondary-100 ring-1 ring-secondary-900/5 transition-transform hover:rotate-1 duration-500">
                <div className="space-y-6">
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-secondary-500 uppercase tracking-wider">You Send</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-secondary-500 uppercase tracking-wider">They Receive</label>
                    <div className="flex items-center justify-between p-4 bg-primary-50/50 rounded-2xl border border-primary-100/50">
                      <div className="text-3xl font-bold text-primary-700">142,500</div>
                  ...
                  <div className="p-4 rounded-xl bg-secondary-50 border border-secondary-100 text-sm space-y-2 font-medium">
                    <div className="flex justify-between text-secondary-500">
                      ...
                      <span className="text-secondary-900">1 USD = 142.50 KES</span>
                    </div>
                    <div className="flex justify-between text-secondary-500">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            <h2 className="text-4xl font-extrabold text-secondary-900 tracking-tight">
              Built for speed. <br />Secured for peace of mind.
            </h2>
            <p className="text-xl text-secondary-600 leading-relaxed">
              We've re-imagined international money transfers to be as simple as sending a text.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="group bg-white p-10 rounded-3xl shadow-sm border border-secondary-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
        ...
        <div className="max-w-6xl mx-auto relative overflow-hidden bg-primary-600 rounded-[3rem] p-12 sm:p-20 text-center">
          ...
          <div className="relative z-10 space-y-8">
            <h2 className="text-4xl sm:text-6xl font-extrabold text-white tracking-tight">
              Ready to transcend <br />boundaries?
            </h2>
            <p className="text-xl text-primary-100 max-w-2xl mx-auto">
              Join 2 million users moving money with confidence. Create your free account in less than 2 minutes.
            </p>
      ...
      <footer className="bg-white border-t border-secondary-100 pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-12 gap-16 mb-20">
            <div className="md:col-span-4 space-y-6">
              <Link to="/" className="flex items-center gap-3">
                ...
                <span className="text-xl font-bold text-secondary-900 tracking-tight">Remit</span>
              </Link>
              <p className="text-secondary-500 leading-relaxed">
                Empowering global communities with seamless, secure, and instant financial borders.
              </p>
              <div className="flex gap-4">
                {/* Social links placeholders */}
                {[1, 2, 3].map(i => (
                  <div key={i} className="w-10 h-10 bg-secondary-50 rounded-full flex items-center justify-center hover:bg-primary-50 hover:text-primary-600 transition-colors cursor-pointer text-secondary-400">
            ...
            <div className="md:col-span-8 grid grid-cols-2 sm:grid-cols-3 gap-12">
              <div>
                <h4 className="font-bold text-secondary-900 mb-6 uppercase tracking-wider text-xs">Product</h4>
                <ul className="space-y-4 text-secondary-500 font-medium">
                  <li><a href="#" className="hover:text-primary-600 transition-colors">Personal</a></li>
              ...
              <div>
                <h4 className="font-bold text-secondary-900 mb-6 uppercase tracking-wider text-xs">Support</h4>
                <ul className="space-y-4 text-secondary-500 font-medium">
              ...
              <div className="col-span-2 sm:col-span-1">
                <h4 className="font-bold text-secondary-900 mb-6 uppercase tracking-wider text-xs">Legal</h4>
                <ul className="space-y-4 text-secondary-500 font-medium">
          ...
          <div className="pt-12 border-t border-secondary-100 flex flex-col md:row items-center justify-between gap-6 text-sm font-medium text-secondary-400">
            <p>&copy; 2024 Remit. International money transfer redefined.</p>
