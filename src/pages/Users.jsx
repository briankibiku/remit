        ...
        <div className="max-w-7xl mx-auto px-6 py-10 lg:px-12">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6 animate-fade-in">
            ...
            <button 
              ...
              className="flex items-center gap-2 px-6 py-3 bg-primary-600 text-white rounded-2xl font-bold hover:bg-primary-700 transition-all active:scale-95 shadow-lg shadow-primary-500/20"
            >
              <svg
                className="w-5 h-5"
                fill="none"
            ...
            <div className="bg-white rounded-[2.5rem] shadow-sm border border-secondary-100 overflow-hidden animate-slide-up">
                ...
                <table className="w-full text-left">
                  <thead>
                    <tr className="border-b border-secondary-50">
                      <th className="px-8 py-5 text-xs font-black uppercase tracking-widest text-secondary-400">
                        User Information
                      </th>
                      <th className="px-8 py-5 text-xs font-black uppercase tracking-widest text-secondary-400">
                        Role
                      ...
                      <th className="px-8 py-5 text-xs font-black uppercase tracking-widest text-secondary-400 text-right">
                        Actions
                      </th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-secondary-50">
                    {users.map((u) => (
                      ...
                      >
                        ...
                        <td className="px-8 py-6">
                          <span className="text-secondary-600 font-bold text-sm tracking-tight">
                            {u.role}
                          </span>
                        </td>
                        <td className="px-8 py-6">
              ...
              <div className="p-8 bg-secondary-50/30 border-t border-secondary-50 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  <button
                    className="px-4 py-2 bg-white border border-secondary-100 rounded-xl text-secondary-400 font-bold hover:text-secondary-900 transition-all active:scale-95 disabled:opacity-50"
                    disabled
                  >
                    Previous
                  </button>
                  <button className="px-4 py-2 bg-white border border-secondary-100 rounded-xl text-secondary-900 font-bold hover:bg-secondary-50 transition-all active:scale-95">
                    Next
                  </button>
                </div>
              </div>
