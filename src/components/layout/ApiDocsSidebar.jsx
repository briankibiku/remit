  ...
  const sections = [
    {
      ...
      items: [
        ...
        { id: "auth-partner", label: "Authenticate Partner" }
      ]
    },
    {
      title: "Resources",
      items: [
        ...
        { id: "regenerate-key", label: "Regenerate API Key" },
        { id: "regenerate-webhook", label: "Regenerate Webhook Secret" },
        { id: "transact", label: "Transact" },
        { id: "create-wallet", label: "Create Wallet" },
        { id: "list-wallets", label: "List Wallets" },
